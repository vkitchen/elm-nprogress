		...
		switch (_p0.ctor) {
			case 'Start':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{progress: _user$project$Progress$start, loading: true}),
			...
			case 'Loaded':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{progress: _user$project$Progress$init, loading: false}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
				return {
...
var _user$project$Main$init = {
	ctor: '_Tuple2',
	_0: {progress: _user$project$Progress$init, loading: true},
	_1: _elm_lang$core$Platform_Cmd$none
};
...
var _user$project$Main$config = _user$project$Progress$config(
	{toMsg: _user$project$Main$UpdateProgress, toLoaded: _user$project$Main$Loaded});
var _user$project$Main$subscriptions = function (model) {
	return A2(_user$project$Progress$subscriptions, _user$project$Main$config, model.progress);
};
		...
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: model.loading ? _elm_lang$html$Html$text('') : _elm_lang$html$Html$text('Page has loaded'),
						_1: {ctor: '[]'}
					}
				}
			}
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Main.Msg":{"args":[],"tags":{"Loaded":[],"Start":[],"Done":[],"UpdateProgress":[]}}},"aliases":{},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
