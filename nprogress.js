	...
	function (_p1, _p0) {
		...
		var transform = A2(
			...
			A2(
				_elm_lang$core$Basics_ops['++'],
				_elm_lang$core$Basics$toString(
					A3(_elm_lang$core$Basics$clamp, 0, 100, 100 - (_p4 * 100))),
				'%, 0px, 0px)'));
				...
				_1: {
					...
					_1: {
						...
						_0: A2(
							...
							'opacity',
							(_elm_lang$core$Native_Utils.cmp(_p4, 2) < 0) ? '1' : '0'),
						_1: {ctor: '[]'}
					}
				}
			});
...
var _user$project$Progress$State = F2(
	function (a, b) {
		return {ctor: 'State', _0: a, _1: b};
	});
var _user$project$Progress$init = A2(_user$project$Progress$State, false, 0);
var _user$project$Progress$done = function (_p5) {
	var _p6 = _p5;
	return A2(_user$project$Progress$State, true, _p6._1);
};
var _user$project$Progress$subscriptions = F2(
	function (_p8, _p7) {
		var _p9 = _p8;
		var _p14 = _p9._0.toMsg;
		var _p10 = _p7;
		var _p13 = _p10._1;
		var increase = function (_p11) {
			var _p12 = _p10._0;
			if (_p12 === false) {
				return _p14(
					(_elm_lang$core$Native_Utils.cmp(_p13, 0.2) < 0) ? A2(_user$project$Progress$State, false, _p13 + 0.1) : ((_elm_lang$core$Native_Utils.cmp(_p13, 0.5) < 0) ? A2(_user$project$Progress$State, false, _p13 + 4.0e-2) : ((_elm_lang$core$Native_Utils.cmp(_p13, 0.8) < 0) ? A2(_user$project$Progress$State, false, _p13 + 2.0e-2) : ((_elm_lang$core$Native_Utils.cmp(_p13, 0.99) < 0) ? A2(_user$project$Progress$State, false, _p13 + 5.0e-3) : A2(_user$project$Progress$State, false, _p13)))));
			} else {
				return (_elm_lang$core$Native_Utils.cmp(_p13, 2) < 0) ? _p14(
					A2(_user$project$Progress$State, true, _p13 + 0.8)) : _p9._0.toLoaded;
			}
		};
...
var _user$project$Progress$config = function (_p15) {
	var _p16 = _p15;
	return _user$project$Progress$Config(
		{toMsg: _p16.toMsg, toLoaded: _p16.toLoaded});
};
			...
			case 'Start':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{loading: true, progress: _user$project$Progress$init}),
...
var _user$project$Main$init = {
	ctor: '_Tuple2',
	_0: {progress: _user$project$Progress$init, loading: false},
	_1: _elm_lang$core$Platform_Cmd$none
};
...
var _user$project$Main$Model = F2(
	function (a, b) {
		return {progress: a, loading: b};
	});
var _user$project$Main$SetProgress = function (a) {
	return {ctor: 'SetProgress', _0: a};
};
var _user$project$Main$Loaded = {ctor: 'Loaded'};
var _user$project$Main$config = _user$project$Progress$config(
	{toMsg: _user$project$Main$SetProgress, toLoaded: _user$project$Main$Loaded});
var _user$project$Main$subscriptions = function (model) {
	return model.loading ? A2(_user$project$Progress$subscriptions, _user$project$Main$config, model.progress) : _elm_lang$core$Platform_Sub$none;
};
var _user$project$Main$Done = {ctor: 'Done'};
...
var _user$project$Main$view = function (model) {
	return A2(
		...
		A2(
			_elm_lang$core$Basics_ops['++'],
			{
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$Done),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
			...
			model.loading ? {
				ctor: '::',
				_0: A2(_user$project$Progress$view, _user$project$Main$config, model.progress),
				_1: {ctor: '[]'}
			} : {ctor: '[]'}));
};
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Progress.State":{"args":[],"tags":{"State":["Bool","Float"]}},"Main.Msg":{"args":[],"tags":{"SetProgress":["Progress.State"],"Loaded":[],"Start":[],"Done":[]}}},"aliases":{},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
